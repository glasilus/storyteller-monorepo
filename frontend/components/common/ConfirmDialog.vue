<template>
  <div>
    <div v-if="isOpen" class="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <!-- Modal -->
      <div class="relative bg-base-100 rounded-lg shadow-xl p-6 max-w-md w-full mx-4 z-10">
...
onMounted(() => {
  ...
  console.log('[ConfirmDialog] Initial isOpen:', isOpen.value)
})

watch(isOpen, (val) => {
  console.log('[ConfirmDialog] isOpen changed:', val)
}, { immediate: true })
</script>
