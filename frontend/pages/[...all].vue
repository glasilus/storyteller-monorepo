<template>
  ...
  const scriptFragments = ref([
    ...
    { text: 'Знаете ли вы, что...', x: 20, y: 70, opacity: 0.8 },
    { text: 'Я мопс, мне...?', x: 75, y: 80, opacity: 0.5 },
    { text: 'Он выжил... но не ожидал этого', x: 15, y: 25, opacity: 0.75 },
    { text: 'Никто не верил, пока...', x: 60, y: 40, opacity: 0.65 },
    { text: 'Это изменило всё за 3 секунды', x: 25, y: 60, opacity: 0.8 },
    { text: 'Она сказала "да"... но не ему', x: 70, y: 50, opacity: 0.6 },
    { text: 'Через час его не стало...', x: 30, y: 75, opacity: 0.7 },
    { text: 'А потом раздался крик', x: 45, y: 35, opacity: 0.85 },
    { text: 'Он не знал, что это — ловушка', x: 10, y: 55, opacity: 0.7 },
    { text: 'Её секрет шокировал всех', x: 80, y: 65, opacity: 0.6 },
    { text: 'Это было не то, чем казалось', x: 50, y: 20, opacity: 0.75 },
    { text: 'Он проснулся... в другом теле', x: 20, y: 85, opacity: 0.6 },
    { text: 'Они думали, что всё кончено...', x: 65, y: 30, opacity: 0.7 },
    { text: 'А ведь началось всё с мелочи', x: 35, y: 45, opacity: 0.8 },
    { text: 'Никто не заметил подвоха', x: 75, y: 25, opacity: 0.65 },
    { text: 'Она исчезла без следа', x: 15, y: 65, opacity: 0.7 },
    { text: 'Это видео запрещено в 12 странах', x: 55, y: 80, opacity: 0.6 },
    { text: 'А вы бы так смогли?', x: 40, y: 70, opacity: 0.8 },
    { text: 'Секунда — и жизнь изменилась', x: 25, y: 15, opacity: 0.75 },
    { text: 'Он не подозревал, что за ним следят', x: 70, y: 55, opacity: 0.6 },
    { text: 'Это не мем... это правда', x: 10, y: 40, opacity: 0.8 },
    { text: 'Она вернулась... спустя 10 лет', x: 60, y: 75, opacity: 0.7 }
  ])
